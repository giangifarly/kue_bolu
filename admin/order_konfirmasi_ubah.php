					...
					<div class="col-6">
						<div class="form-group row">
							...
							<select name="nama_pemesan" class="form-control col-9">
								...
								<option value="Sudah Sampai" selected>Gian Gifarly</option>
							</select>
                        ...
                        <div class="form-group row">
							...
							<select name="no_pesanan" class="form-control col-9">
								...
								<option value="74894" selected>74894</option>
                        ...
                        <div class="form-group row">
							...
							<select name="status_pengiriman" class="form-control col-9">
								...
								<option value="Sudah Sampai" selected>Sudah Sampai</option>
							</select>
                        </div>
                        ...
                        <div class="form-group row">
							...
							<input type="text" class="form-control col-9" name="telepon" aria-describedby="helpId"
								placeholder="Masukkan Jumlah Bayar" value="470900">
							<small id="helpId" class="form-text text-muted"></small>
                        </div>
                        <div class="form-group">
                            <input class="btn btn-success" type="submit" value="Ubah Pembayaran">
                        </div>
